...
VCUG_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Currency.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Mass_Gramm.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Volume_ml.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Speed.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length_cm.vcug 
...
ALGRP_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/SystemAlarms.algrp \
	$(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/CoffeeMachine.algrp 
...
$(AS_CPU_PATH)/VCShared/vcug.Currency.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Currency.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Mass_Gramm.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Mass_Gramm.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Volume_ml.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Volume_ml.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
...
$(AS_CPU_PATH)/VCShared/vcug.Length_cm.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length_cm.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
...
$(AS_CPU_PATH)/VCShared/algrp.CoffeeMachine.vco: $(AS_PROJECT_PATH)/Logical/VCShared/AlarmGroups/CoffeeMachine.algrp
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
